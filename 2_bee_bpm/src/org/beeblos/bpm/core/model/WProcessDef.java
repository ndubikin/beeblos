...
@XmlType(propOrder = {"workflowObj", "layerObjectList", "symbolObjectList", "steps", "stepSequenceList"})
...
//	private List<WStepDef> lSteps = new ArrayList<WStepDef>();
	 ...
	 * pab 20141201
	 * 
	 * Workflow element from the xml
	 */
	private Workflow workflowObj;
	private String xmlWorkflowString;
	/**
	 * pab 20141201
	 * 
	 * Layer elements in the xml.
	 */
	private List<Layer> layerObjectList;
	private String xmlLayersString;
	
	/**
	 * pab 20141201
	 * 
	 * This represents the objects called "symbol" in the XML. They are used to represent "start" and "end" elements in said XML.
	 */
	private List<Symbol> symbolObjectList;
	private String xmlSymbolsString;
...
//	}
	...
	public List<Layer> getLayerObjectList() {
		return layerObjectList;
	}

	/**
	 * @param layerObjectList the layerObjectList to set
	 */
	public void setLayerObjectList(List<Layer> layerObjectList) {
		this.layerObjectList = layerObjectList;
	}
	
	/**
	 * @return the xmlLayersString
	 */
	public String getXmlLayersString() {
		return xmlLayersString;
	}

	/**
	 * @param xmlLayersString the xmlLayersString to set
	 */
	public void setXmlLayersString(String xmlLayersString) {
		this.xmlLayersString = xmlLayersString;
	}

	/**
	 * pab 20141201
	 * 
	 * This are the objects called "symbol" in the XML. They are used to represent "start" and "end" elements in said XML.
	 * 
	 * @return symbolObjectList
	 */
	@XmlElement(name="Symbol")
	public List<Symbol> getSymbolObjectList() {
		return symbolObjectList;
	}

	/**
	 * @param symbolObjectList the symbolObjectList to set
	 */
	public void setSymbolObjectList(List<Symbol> xmlSymbols) {
		this.symbolObjectList = xmlSymbols;
	}
	...
	/**
	 * @return the xmlSymbolsString
	 */
	public String getXmlSymbolsString() {
		return xmlSymbolsString;
	}

	/**
	 * @param xmlSymbolsString the xmlSymbolsString to set
	 */
	public void setXmlSymbolsString(String xmlSymbolsString) {
		this.xmlSymbolsString = xmlSymbolsString;
	}
	...
	/**
	 * @param workflowObj the workflowObj to set
	 */
	public void setWorkflowObj(Workflow w) {
		this.workflowObj = w;
	}

	/**
	 * @return the xmlWorkflowString
	 */
	public String getXmlWorkflowString() {
		return xmlWorkflowString;
	}

	/**
	 * @param xmlWorkflowString the xmlWorkflowString to set
	 */
	public void setXmlWorkflowString(String workflowString) {
		this.xmlWorkflowString = workflowString;
	}
