/**
 * Tipo auxiliar para manejar las listas de documentos adjuntos
 */
 ...
 *
 */
public class BeeblosAttachment implements Serializable {
	...
	public BeeblosAttachment() {
		super();

	}


	public BeeblosAttachment(Integer docId, String documentoNombre,
