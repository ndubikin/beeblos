...
public class WProcessDef implements java.io.Serializable {
	...
	private Boolean stepDefaultUseFieldList;  //rrl 20130731
	...
	//rrl 20130731
	public Boolean getStepDefaultUseFieldList() {
		return stepDefaultUseFieldList;
	}

	public void setStepDefaultUseFieldList(Boolean stepDefaultUseFieldList) {
		this.stepDefaultUseFieldList = stepDefaultUseFieldList;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((lSteps == null) ? 0 : lSteps.hashCode());
		result = prime * result + ((process == null) ? 0 : process.hashCode());
		result = prime * result
				+ ((processMap == null) ? 0 : processMap.hashCode());
		result = prime * result
		...
		result = prime
				* result
				+ ((stepDefaultUseFieldList == null) ? 0
						: stepDefaultUseFieldList.hashCode());
		result = prime
				* result
				+ ((stepSequenceList == null) ? 0 : stepSequenceList.hashCode());
		result = prime
				* result
	...
	public boolean equals(Object obj) {
		...
		if (idWorkZone == null) {
			...
			return false;
		if (lSteps == null) {
			if (other.lSteps != null)
				return false;
		} else if (!lSteps.equals(other.lSteps))
			return false;
		if (process == null) {
		...
		if (rolesRelated == null) {
			...
			return false;
		if (stepDefaultUseFieldList == null) {
			if (other.stepDefaultUseFieldList != null)
				return false;
		} else if (!stepDefaultUseFieldList
				.equals(other.stepDefaultUseFieldList))
			return false;
		if (stepSequenceList == null) {
			if (other.stepSequenceList != null)
				return false;
		} else if (!stepSequenceList.equals(other.stepSequenceList))
			return false;
	...
	public String toString() {
		return "WProcessDef [id=" + id + ", process=" + process + ", version="
				+ version + ", active=" + active + ", productionDate="
				+ productionDate + ", productionUser=" + productionUser
				+ ", comments=" + comments + ", beginStep=" + beginStep
				+ ", idListZone=" + idListZone + ", idWorkZone=" + idWorkZone
				+ ", idAdditionalZone=" + idAdditionalZone
				+ ", idProcessorStep=" + idProcessorStep + ", adminEmail="
				+ adminEmail + ", totalTime=" + totalTime + ", totalTimeUnit="
				...
				+ arrivingUserNoticeTemplate + ", insertDate=" + insertDate
				+ ", insertUser=" + insertUser + ", modDate=" + modDate
				+ ", modUser=" + modUser + ", rolesRelated=" + rolesRelated
				+ ", usersRelated=" + usersRelated + ", lSteps=" + lSteps
				+ ", stepSequenceList=" + stepSequenceList + ", processMap="
				+ processMap + ", stepDefaultUseFieldList="
				+ stepDefaultUseFieldList + "]";
	}
