...
public class TestWProcessDefBL extends TestCase{
		...
		public void testAgregarWProcessDef() throws Exception {
			...
			Integer idStep = stepBL.add(new WStepDef(null,"paso 1",2,3,"ejecute este paso plis","sincomentarios ...",null,null,null),1000);
			...
			new WProcessDefBL().delete( process,1000) ; // con las cascadas esto borra el proceso y las 2 tablas de relacion asociadas ...
